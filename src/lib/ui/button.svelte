<script lang="ts" context="module">
  ...
  export const buttonStyles = tv({
    ...
    variants: {
      variant: {
        default: 'bg-primary hover:bg-primary-focus text-primary-foreground focus-visible:ring-primary-focus shadow-[inset_0_1px_0_#ffffff4d,0_4px_6px_-1px_rgb(0_0_0_/_0.1),_0_2px_4px_-2px_rgb(0_0_0_/_0.1)] dark:shadow-[inset_0_-1px_0_#0000004d]',
        ...
        error: '[text-shadow:_0_1px_0_rgb(0_0_0_/_20%)] bg-error hover:bg-error-focus text-error-foreground focus-visible:ring-error-focus shadow-[inset_0_1px_0_#ffffff4d,0_4px_6px_-1px_rgb(0_0_0_/_0.1),_0_2px_4px_-2px_rgb(0_0_0_/_0.1)]',
        accent: '[text-shadow:_0_1px_0_rgb(0_0_0_/_20%)] bg-accent hover:bg-accent-focus text-accent-foreground focus-visible:ring-accent-focus shadow-[inset_0_1px_0_#ffffff4d,0_4px_6px_-1px_rgb(0_0_0_/_0.1),_0_2px_4px_-2px_rgb(0_0_0_/_0.1)]',
        success: 'bg-success hover:bg-success-focus text-success-foreground focus-visible:ring-success-focus shadow-[inset_0_1px_0_#ffffff4d,0_4px_6px_-1px_rgb(0_0_0_/_0.1),_0_2px_4px_-2px_rgb(0_0_0_/_0.1)]',
        warning: 'bg-warning hover:bg-warning-focus text-warning-foreground focus-visible:ring-warning-focus shadow-[inset_0_1px_0_#ffffff4d,0_4px_6px_-1px_rgb(0_0_0_/_0.1),_0_2px_4px_-2px_rgb(0_0_0_/_0.1)]',
