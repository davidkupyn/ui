<script lang="ts" context="module">
  ...
  export const buttonStyles = tv({
    base: 'inline-flex items-center justify-center rounded-xl active:scale-95 text-sm font-medium [transition:color_150ms,background-color_150ms,border-color_150ms,text-decoration-color_150ms,fill_150ms,stroke_150ms,opacity_150ms,box-shadow_150ms,transform_200ms,filter_150ms,backdrop-filter_150ms] ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ring-offset-background disabled:pointer-events-none disabled:opacity-50',
    variants: {
      variant: {
        default: 'bg-primary hover:bg-primary-focus text-primary-foreground focus-visible:ring-primary [box-shadow:_inset_0_1px_0px_0px_hsl(0_0%_100%/0.4)] dark:[box-shadow:_inset_0_-1px_1px_0px_hsl(240_6%_10%/0.4)]',
        ...
        error: 'bg-error hover:bg-error-focus text-error-foreground focus-visible:ring-error [box-shadow:_inset_0_1px_0px_0px_hsl(0_0%_100%/0.4)]',
        success: 'bg-success hover:bg-success-focus text-success-foreground focus-visible:ring-success [box-shadow:_inset_0_1px_0px_0px_hsl(0_0%_100%/0.4)]',
        warning: 'bg-warning hover:bg-warning-focus text-warning-foreground focus-visible:ring-warning [box-shadow:_inset_0_1px_0px_0px_hsl(0_0%_100%/0.4)]',
        info: 'bg-info hover:bg-info-focus text-info-foreground focus-visible:ring-info [box-shadow:_inset_0_1px_0px_0px_hsl(0_0%_100%_/_0.3)]',
