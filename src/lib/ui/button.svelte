<script lang="ts" context="module">
	...
	export const buttonStyles = tv({
		base: 'group inline-flex gap-x-1.5 items-center justify-center tracking-wide rounded-xl active:scale-95 text-sm font-medium transition ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 ring-offset-background disabled:pointer-events-none disabled:opacity-50',
		variants: {
			variant: {
				default:
					'bg-gradient-to-b from-primary-focus to-primary dark:from-primary dark:to-primary-focus hover:brightness-125 dark:hover:brightness-90 text-primary-foreground focus-visible:ring-primary-focus shadow-[inset_0_1px_0_#ffffff4d,inset_0_-1px_0_#00000010,0_1px_3px_0_rgb(0_0_0_/_0.1),_0_1px_2px_-1px_rgb(0_0_0_/_0.1)]',
				outline:
				...
				error:
					'[text-shadow:_0_1px_0_rgb(0_0_0_/_20%)] hover:brightness-95 dark:hover:brightness-90 bg-gradient-to-b from-error to-error-focus text-error-foreground focus-visible:ring-error-focus shadow-[inset_0_1px_0_#ffffff4d,inset_0_-1px_0_#00000010,0_1px_3px_0_rgb(0_0_0_/_0.1),_0_1px_2px_-1px_rgb(0_0_0_/_0.1)]',
				accent:
					'[text-shadow:_0_1px_0_rgb(0_0_0_/_20%)] hover:brightness-95 dark:hover:brightness-90 bg-gradient-to-b from-accent to-accent-focus text-accent-foreground focus-visible:ring-accent-focus shadow-[inset_0_1px_0_#ffffff4d,inset_0_-1px_0_#00000010,0_1px_3px_0_rgb(0_0_0_/_0.1),_0_1px_2px_-1px_rgb(0_0_0_/_0.1)]',
				success:
					'hover:brightness-95 dark:hover:brightness-90 bg-gradient-to-b from-success-focus to-success text-success-foreground focus-visible:ring-success-focus shadow-[inset_0_1px_0_#ffffff4d,inset_0_-1px_0_#00000010,0_1px_3px_0_rgb(0_0_0_/_0.1),_0_1px_2px_-1px_rgb(0_0_0_/_0.1)]',
				warning:
					'hover:brightness-95 dark:hover:brightness-90 bg-gradient-to-b from-warning-focus to-warning text-warning-foreground focus-visible:ring-warning-focus shadow-[inset_0_1px_0_#ffffff4d,inset_0_-1px_0_#00000010,0_1px_3px_0_rgb(0_0_0_/_0.1),_0_1px_2px_-1px_rgb(0_0_0_/_0.1)]',
				info: '[text-shadow:_0_1px_0_rgb(0_0_0_/_20%)] hover:brightness-95 dark:hover:brightness-90 bg-gradient-to-b from-info to-info-focus text-info-foreground focus-visible:ring-info-focus shadow-[inset_0_1px_0_#ffffff4d,inset_0_-1px_0_#00000010,0_1px_3px_0_rgb(0_0_0_/_0.1),_0_1px_2px_-1px_rgb(0_0_0_/_0.1)]',
				ghost:
