...
>
	...
	{#if value === $valueStore}
		<div
			...
			class={cn(
				'w-full h-full group-data-[orientation=vertical]:rounded-xl rounded-lg bg-background shadow dark:shadow-[0_1px_0_#ffffff1a] group-focus-visible:ring-2 ring-offset-2 ring-muted-foreground dark:ring-border ring-offset-muted'
