...
export const modal = tv({
	slots: {
		base: 'relative z-50 grid w-full max-w-lg shadow-lg focus:outline-none rounded-3xl border border-popover-border bg-popover p-6 gap-6 rounded-t-3xl [--modal-scale:1] sm:[--modal-scale:0.95] [--modal-y:5rem] sm:[--modal-y:0px] [--modal-duration:300] sm:[--modal-duration:200]',
